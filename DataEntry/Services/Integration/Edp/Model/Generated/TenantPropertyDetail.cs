...
{
    public partial class TenantPropertyDetail : EdpGraphQLObject
    {
        [JsonIgnore]
        public override string ResultFields => @"{floor_number,suite_number,sublease_f,leased_space_size,leased_space_size_uom_desc,lease_start_date,lease_expiration_date,headquarter_location_f,tenancy_status,lease_id,occupancy_date,ref_property_usage_type_desc,ref_property_usage_sub_type_desc,brand_id,estimated_rent_amount,estimated_rent_amount_uom,external_opportunity_number,external_opportunity_number_source_desc}";

...
{
    public partial class addFloorPlanMutation : EdpGraphQLMutation<ResultData>
    {
        [JsonIgnore]
        protected override string QueryName { get { return @"addFloorPlan"; } }
        ...
        protected override IEnumerable<KeyValuePair<string, object>> Args 
        {
            get 
            {
                ...
                yield return new KeyValuePair<string, object>(@"floor_plan_url", floor_plan_url);

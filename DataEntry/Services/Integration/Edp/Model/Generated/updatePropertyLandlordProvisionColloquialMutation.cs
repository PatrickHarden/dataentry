...
{
    public partial class updatePropertyLandlordProvisionColloquialMutation : EdpGraphQLMutation<ResultData>
    {
        [JsonIgnore]
        protected override string QueryName { get { return @"updatePropertyLandlordProvisionColloquial"; } }
        ...
        public PropertyLandlordProvisionColloquialUpdate colloquial { get; set; }
    }
}

...
{
    public partial class deletePhonesMutation : EdpGraphQLMutation<ResultData>
    {
        [JsonIgnore]
        protected override string QueryName { get { return @"deletePhones"; } }
        ...
        public List<PhoneDelete> phones { get; set; }
    }
}

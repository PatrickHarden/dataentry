...
{
    public partial class PropertyMediaInformation : EdpGraphQLObject
    {
        [JsonIgnore]
        ...
        [JsonProperty(@"photographer_party_skey", NullValueHandling = NullValueHandling.Ignore)]
        public int? photographer_party_skey { get; set; }
        ...
        [JsonProperty(@"watermark_label", NullValueHandling = NullValueHandling.Ignore)]
        public string watermark_label { get; set; }

        [JsonProperty(@"watermark_precision_probability", NullValueHandling = NullValueHandling.Ignore)]
        public decimal? watermark_precision_probability { get; set; }

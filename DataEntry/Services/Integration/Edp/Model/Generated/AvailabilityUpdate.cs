...
namespace dataentry.Services.Integration.Edp.Model
{
    public partial class AvailabilityUpdate : EdpGraphQLObject
    {
        ...
        [JsonProperty(@"available_space", NullValueHandling = NullValueHandling.Ignore)]
        ...
        [JsonProperty(@"ref_availability_type_desc", NullValueHandling = NullValueHandling.Ignore)]

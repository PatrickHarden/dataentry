...
namespace dataentry.Services.Integration.Edp.Model
{
    public partial class LeaseCompUpdate : EdpGraphQLObject
    {
        ...
        [JsonProperty(@"total_leased_space", NullValueHandling = NullValueHandling.Ignore)]
        public decimal? total_leased_space { get; set; }

        [JsonProperty(@"ref_total_leased_space_uom_desc", NullValueHandling = NullValueHandling.Ignore)]

...
{
    public partial class PropertyParking : EdpGraphQLObject
    {
        [JsonIgnore]
        public override string ResultFields => @"{id,parking_comments,parking_type_desc,parking_sub_type_desc,parking_cost_monthly,parking_cost_monthly_uom,parking_cost_hourly,parking_cost_hourly_uom,parking_cost_hourly_start,parking_cost_hourly_start_uom,parking_cost_hourly_end,parking_cost_hourly_end_uom,parking_cost_monthly_start,parking_cost_monthly_start_uom,parking_cost_monthly_end,parking_cost_monthly_end_uom}";
        ...
        [JsonProperty(@"parking_type_desc", Required = Required.Always)]
        public string parking_type_desc { get; set; }

        [JsonProperty(@"parking_sub_type_desc", Required = Required.Always)]
        public string parking_sub_type_desc { get; set; }

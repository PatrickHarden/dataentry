...
{
    public partial class PropertyAirConditionUnified : EdpGraphQLObject
    {
        [JsonIgnore]
        public override string ResultFields => @"{id,property_air_condition_desc,property_air_condition_note,week_day_type_desc,start_time,end_time}";
        ...
        public int? property_air_condition_note { get; set; }

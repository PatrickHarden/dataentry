...
{
    public partial class deleteLeasePropertyMeasurementMutation : EdpGraphQLMutation<ResultData>
    {
        [JsonIgnore]
        protected override string QueryName { get { return @"deleteLeasePropertyMeasurement"; } }
